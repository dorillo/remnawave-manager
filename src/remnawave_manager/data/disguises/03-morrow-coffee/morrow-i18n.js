const dictionary = {
  ...
  choosePhoto: ["Выбрать изображение", "Choose image"],
  chooseVideo: ["Выбрать видео", "Choose video"],
  ...
  deleteVideoText: [
    "Удалить это видео? Это действие нельзя отменить.",
  ...
  deleteAccountText: [
    "Все данные этого аккаунта будут удалены.",
