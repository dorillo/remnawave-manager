...
class CompatibilityTests(unittest.TestCase):
    ...
    def test_panel_and_node_3_3_1_are_approved_update_sources(self) -> None:
        cases = (
            (
                "panel",
                "remnawave/backend:3.3.1",
                "sha256:1d0354e476a218a9f5611c23cab39299a63a83a9c7d94353628b911154f569af",
            ),
            (
                "node",
                "remnawave/node:3.3.1",
                "sha256:e95373bdd8f186141bb7108863c45ab74e5e7ea29fbce6bd46b5b86b7ef68d0f",
            ),
        )
        for name, image, digest in cases:
            with self.subTest(component=name):
                image_id = "sha256:" + ("7" if name == "panel" else "8") * 64
                component = Component(
                    name=name,
                    service=name,
    ...
    def test_all_panel_and_node_3_4_releases_are_approved_update_sources(self) -> None:
        cases = (
            (
                "panel",
    ...
    def test_managed_node_3_2_2_is_an_approved_update_source(self) -> None:
        digest = "6a4c26eb07c91c5eb10fa0ff7f6defda8b49a3557f2dc25fa13a0110bde646e2"
        component = Component(
            name="node",
            service="remnanode",
            configured_image="remnawave/node:3.2.2",
            running_image="remnawave/node:3.2.2",
            running_image_id="sha256:" + "7" * 64,
        )
        runner = FakeRunner(
            ["remnawave/node@sha256:" + digest],
            container_data={
                "Config": {"Image": component.running_image},
                "Image": component.running_image_id,
            },
        ...
        self.assertEqual(require_supported_source(runner, "node", component), "3.2.2")
