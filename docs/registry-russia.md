...
| --- | --- | --- |
| `docker-hub` | `docker.io` | Panel 3.2.0, Subscription Page 8.0.0, Node 3.0.0 |
| `ghcr` | `ghcr.io` | Panel 3.2.0, Node 3.0.0 |
...
- [миграция Panel](migration-panel-2.8.1-to-3.2.0.md)
